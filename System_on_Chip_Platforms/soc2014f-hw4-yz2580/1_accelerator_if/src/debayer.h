...
SC_MODULE(debayer) {
	...
	void wami_debayer(int rows, int cols);

	// Declare member variables here
	u16 bayer_img[IMG_NUM_ROWS][IMG_NUM_COLS];
	rgb_pixel debayer_img[IMG_NUM_ROWS-2*PAD][IMG_NUM_COLS-2*PAD];
